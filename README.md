...
В папка Extras има клас, който позволява ползването на блутут-а на esp32. Още не съм го имплементирал в главният main.py, но може да се ползва за UART дебъг докато станцията работи. Има примерен код в същата папка.
